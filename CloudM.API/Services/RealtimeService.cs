...
namespace CloudM.API.Services
{
    ...
    public class RealtimeService : IRealtimeService
    {
        ...
        public async Task NotifyProfileUpdatedAsync(Guid accountId, CloudM.Application.DTOs.AccountDTOs.AccountDetailResponse account)
        {
            await _userHubContext.Clients.Group($"Account-{accountId}")
                .SendAsync("ReceiveProfileUpdate", account);
        }

        public async Task NotifyAccountSettingsUpdatedAsync(Guid accountId, CloudM.Application.DTOs.AccountSettingDTOs.AccountSettingsResponse settings)
        {
            await _userHubContext.Clients.Group($"Account-{accountId}")

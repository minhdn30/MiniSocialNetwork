...
namespace CloudM.Infrastructure.Migrations
{
    ...
    [Migration("20260222205743_AddStorySchema")]
    partial class AddStorySchema
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("CloudM.Domain.Entities.Story", b =>
                {
                    ...
                    b.ToTable("Stories", t =>
                        {
                            t.HasCheckConstraint("CK_Stories_ContentPayload", "((\"ContentType\" IN (0,1) AND \"MediaUrl\" IS NOT NULL AND \"TextContent\" IS NULL) OR (\"ContentType\" = 2 AND \"TextContent\" IS NOT NULL AND length(btrim(\"TextContent\")) > 0 AND \"MediaUrl\" IS NULL))");

...
namespace CloudM.Infrastructure.Migrations
{
    ...
    [Migration("20260223174914_OptimizeFeedStoryIndexes")]
    partial class OptimizeFeedStoryIndexes
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("CloudM.Domain.Entities.Story", b =>
                {
                    ...
                    b.ToTable("Stories", t =>
                        {
                            t.HasCheckConstraint("CK_Stories_ContentPayload", "((\"ContentType\" IN (0,1) AND \"MediaUrl\" IS NOT NULL AND \"TextContent\" IS NULL AND \"BackgroundColorKey\" IS NULL AND \"FontTextKey\" IS NULL AND \"FontSizeKey\" IS NULL AND \"TextColorKey\" IS NULL) OR (\"ContentType\" = 2 AND \"TextContent\" IS NOT NULL AND length(btrim(\"TextContent\")) > 0 AND \"MediaUrl\" IS NULL))");
